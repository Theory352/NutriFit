(function ($) {
  ...
  new WOW().init();
  // $("body").append(
  //   "<a href='https://themeforest.net/checkout/from_item/34825572?license=regular&support=bundle_6month&_ga=2.241445829.634514020.1646539215-1425290503.1590986634' target='_blank' class='buy-now-btn'><img src='assets/images/envato.png' alt='envato'/>Buy Now</a>"
  // );
  // $("body").append(
